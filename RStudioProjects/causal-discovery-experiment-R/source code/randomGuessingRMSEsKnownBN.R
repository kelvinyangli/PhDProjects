randomGuessingRMSEsKnownBN = function(currentDirectory, numIterations) {
  
  dir = paste0(currentDirectory, "/Datasets/Arities/")
  allArities = list.files(dir)
  allArities = orderFilesKnownBN(allArities, numIterations)
  ...
  autoStatsKnownBN(currentDirectory, "randomGuessingRMSEs", "randomGuessing", randomRMSEs, numIterations, alpha = 0.05)
