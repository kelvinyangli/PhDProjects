...
autoFMeasureKnownBN = function(currentDirectory, numIterations) {
  ...
  for (i in 1:length(allTPs)) {
    ...
    autoStatsKnownBN(currentDirectory, learningMethod, "f measure", as.vector(t(fMeasure)), numIterations, alpha = 0.05)
