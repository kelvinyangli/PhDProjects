...
files = list.files(paste0("~/Documents/Experiments/mb_discovery/", model, "/", score, "/", sampleSize, "/with_symmetry/"))
sum_ed = rep(0, length(files)) 
for (i in 1:length(files)) {
  mb_learned = readRDS(paste0("~/Documents/Experiments/mb_discovery/", model, "/", score, "/", sampleSize, "/with_symmetry/", files[i]))
  #ee = c()
  for (j in 1:length(vars)) {
    y = vars[j]
