...
for (i in 1:m) {
  ...
  data = rbn(cpts, n)
  di = getDataInfo(data)
  i1 = mmlCPT(5, c(1, 2, 3, 4), di$indexListPerNodePerValue, di$arities, n) # cpt
  i2 = mmlCPT(1, c(5), di$indexListPerNodePerValue, di$arities, n) + 
    mmlCPT(2, c(5), di$indexListPerNodePerValue, di$arities, n) + 
    mmlCPT(3, c(5), di$indexListPerNodePerValue, di$arities, n) + 
    mmlCPT(4, c(5), di$indexListPerNodePerValue, di$arities, n) # naive bayes
  if (i1 > i2) {
    v[i] = 1
  }
}
