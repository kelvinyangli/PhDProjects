...
```{r}
folder = "insurance"
dir = paste0("~/Documents/Experiments/UAI_exp/", folder, "/")
dag = readRDS(paste0(dir, "dag/", folder, ".rds"))
n = 1000
...
for (i in 1:length(datasets)) {
  ...
  for (j in 1:nvars) {
    ...
    # cat(ed, "\n")
    # 
    # mbcpt[[j]] = forward_greedy_fast(data, di, arities, vars, n, vars[j], debug = F)
  ...
  saveRDS(mbrand, paste0("~/Documents/Experiments/kdd_exp/", folder, "/mml_rand/", n, "/without_symmetry/", filename, ".rds"))
  saveRDS(mbrand_sym, paste0("~/Documents/Experiments/kdd_exp/", folder, "/mml_rand/", n, "/with_symmetry/", filename, ".rds"))
}
```
...
model = "mml_rand"
symtry = "without_symmetry"
files = list.files(paste0("~/Documents/Experiments/kdd_exp/", folder, "/", model, "/", n, "/", symtry, "/"))
cat(length(files), "\n")
edrand = rep(list(rep(0, nvars)), length(files))
for (i in 1:length(files)) {
  mbrand = readRDS(paste0("~/Documents/Experiments/kdd_exp/", folder, "/", model, "/", n, "/", symtry, "/", files[i]))
