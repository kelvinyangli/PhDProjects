...
for (i in 8:length(datasets)) {
  ...
  saveRDS(mbrand, paste0("~/Documents/Experiments/kdd_exp/", model, "/mml_rand/", n, "/without_symmetry/", filename, ".rds"))
  saveRDS(mbrand_sym, paste0("~/Documents/Experiments/kdd_exp/", model, "/mml_rand/", n, "/with_symmetry/", filename, ".rds"))
...
for (method in c("mml_cpt", "mml_nb", "mml_rand")) {
