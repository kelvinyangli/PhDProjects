...
# this code works for general dags as well
...
f2 = function(dag, data, di, arities, vars, target, n, debug = FALSE) {
  ...
  l_perfect = mml_rand_str(str, data, vars, arities, targetAdptProbs, targetIndex, n)
...
for (target in vars) {
  ...
  lrand2[[i]] = f2(dag, data,di,arities,vars,target,n)
