...
f = function(data, arities, vars, target, n) {
...
for (target in vars) {
  cat(i, "\n")
  lrand[[i]] = f(data, arities, vars, target, n) 
  lcpt[[i]] = forward_greedy_fast(data, di, arities, n, target, debug = F)
  lnb[[i]] = forward_greedy(data, arities, vars, n, target, mml_nb_adaptive, debug = F)
  i = i + 1
