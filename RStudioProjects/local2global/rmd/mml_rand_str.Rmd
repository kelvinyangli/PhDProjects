...
# model = "mml_rand"
# files = list.files(paste0("~/Documents/Experiments/mb_discovery/child/", model, "/500/without_symmetry/"))
# for (i in 1:length(files)) {
#   mbrand = readRDS(paste0("~/Documents/Experiments/mb_discovery/child/", model, "/500/without_symmetry/", files[i]))
