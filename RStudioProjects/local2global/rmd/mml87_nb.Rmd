...
for (i in 1:nrow(data)) {
  ...
  ss = ss + log(do.call("[", c(list(cptsEst$Y$prob), as.list(valueIndices))))
}
cat("1st:", i_cpt + ss, "\n")
cat("2nd:", -ss, "\n")
```
...
* lattice constant 1/2*pi*e for mml cpt

* first part of nb sometimes < 0 this is not right

Questions: 
* log factorial is stirling's approximate, so hardly get exact values, the smaller the sample size, the larger the difference, what to do? R upper limit is around factorial(170)
