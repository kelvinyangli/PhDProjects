...
cat("*** 0.5*log(det)=", 0.5*logF, "\n")
cat("*** lattice=", 0.5*d*(1+log(kd)), "\n")
...
```{r}
di = getDataInfo(data)
mmlCPT(yIndex, xIndices, di$indexListPerNodePerValue, di$arities, n)
```
...
post = querygrain(obj, nodes = c("Y", "X1", "X2", "X3"), type = "conditional")
nll2 = 0
