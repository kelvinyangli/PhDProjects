...
```{r global_options, include=F, warning=F, message=F, eval=T, echo=FALSE}
...
(i_cpt = mml_cpt(indexListPerNodePerValue, arities, sampleSize, xIndices, yIndex, logFactorialSheet, base = exp(1)))
```
