...
#' @param type An argument to specify removing either nodes or edges from the original graph. Only two
#' values are taken. That is, "nodes" or "edges".
#' @keywords subgraph
#' @export

subgraph = function(graph, nodes = NULL, from = NULL, to = NULL, type = c("nodes", "edges")) {
